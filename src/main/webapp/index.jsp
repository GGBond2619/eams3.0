    ...
    <div class="lyear-layout-container">
        ...
        <aside class="lyear-layout-sidebar">
            ...
            <div id="logo" class="sidebar-header">
                <a href="${pageContext.request.contextPath}/index.jsp"><img src="../images/logo-sidebar.png"
                                                                            title="byau" alt="byau"/></a>
            </div>
            <div class="lyear-layout-sidebar-scroll">

                <nav class="sidebar-main">
                    <ul class="nav nav-drawer">
                        <li class="nav-item active"><a href="${pageContext.request.contextPath}/index.jsp"><i
                        ...
                        <li class="nav-item nav-item-has-subnav">
                            ...
                            <ul class="nav nav-subnav">
                                ...
                                <li class="nav-item nav-item-has-subnav">
                                    ...
                                    <ul class="nav nav-subnav">
                                        <li>
                                            <a href="${pageContext.request.contextPath}/devicelog/subdevice">元器件使用/分发</a>
                                        </li>
                                        <li><a href="${pageContext.request.contextPath}/devicelog/adddevice">元器件入库</a>
                                        </li>
                                        <li><a href="${pageContext.request.contextPath}/devicelog/findAll">元器件操作日志</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                        ...
                        <li class="nav-item">
                            <a href="errorInfo.jsp"><i class="mdi mdi-comment-remove-outline"></i> 错误信息反馈</a>
                        </li>
                    </ul>
                </nav>
                ...
                <div class="row">
                        ...
                        <div class="card bg-primary">
                            <div class="card-body clearfix">
                                <div class="pull-right">
                                    <p class="h6 text-white m-t-0">指导教师总数</p>
                                    <p id="teachercount" class="h3 text-white m-b-0"></p>
                                </div>
                                <div class="pull-left"><span class="img-avatar img-avatar-48 bg-translucent"><i
                                        class="mdi mdi-account-box fa-1-5x"></i></span></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card bg-danger">
                            <div class="card-body clearfix">
                                <div class="pull-right">
                                    <p class="h6 text-white m-t-0">协会成员总数</p>
                                    <p id="studentcount" class="h3 text-white m-b-0"></p>
                                </div>
                                <div class="pull-left"><span class="img-avatar img-avatar-48 bg-translucent"><i
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card bg-success">
                            <div class="card-body clearfix">
                                <div class="pull-right">
                                    <p class="h6 text-white m-t-0">比赛总数</p>
                                    <p id="competitioncount" class="h3 text-white m-b-0"></p>
                                </div>
                                <div class="pull-left"><span class="img-avatar img-avatar-48 bg-translucent"><i
                                        class="mdi mdi-motorbike fa-1-5x"></i></span></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card bg-purple">
                            <div class="card-body clearfix">
                                <div class="pull-right">
                                    <p class="h6 text-white m-t-0">历史活动量</p>
                                    <p id="activitycount" class="h3 text-white m-b-0"></p>
                                </div>
                                <div class="pull-left"><span class="img-avatar img-avatar-48 bg-translucent"><i
                                        class="mdi mdi-walk fa-1-5x"></i></span></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <div align="center"><img width="20%" src="img/p2.png"/><img src="img/p001.png"/></div>
                            </div>
                            <div class="card-body">
                            <%----%>
                            </div>
...
<script type="text/javascript">
    $(function () {
        ...
        $.ajax({
            type: "GET",
            contentType: 'application/json;charset=utf-8',
            url: "index/teachercount",
            success: function (count) {
                $("#teachercount").text(count);
            }
        });
        $.ajax({
            type: "GET",
            contentType: 'application/json;charset=utf-8',
            url: "index/competitioncount",
            success: function (count) {
                $("#competitioncount").text(count);
            }
        });
        $.ajax({
            type: "GET",
