            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    ...
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 比赛信息管理 - 修改比赛信息 </span>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form id="updateCompetitionForm" action="/competition/updateCompetition"
                                      data-parsley-validate
                                      class="form-horizontal form-label-left" onsubmit="return false;">
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                               for="updateCompetitionForm">竞赛名称
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="last-name" name="cname" value="${competition.cname}"
                                                   class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="updateCompetitionForm"
                                               class="control-label col-md-3 col-sm-3 col-xs-12">比赛类型</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="ctype" class="form-control col-md-7 col-xs-12" type="text"
                                                   value="${competition.ctype}" name="ctype">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                               for="updateCompetitionForm">开始时间</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="cbegintime" name="cbegintime"
                                                   class="date-picker form-control col-md-7 col-xs-12" type="text"
                                                   value="${competition.cbegintime}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                               for="updateCompetitionForm">比赛地点</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="cplace" name="cplace"
                                                   class="date-picker form-control col-md-7 col-xs-12" type="text"
                                                   value="${competition.cplace}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-sm-6 col-xs-18 col-md-offset-4">
                                            <button id="returnbtn" class="btn btn-primary" href="/competition/findAll"
                                                    type="button">取消
                                            </button>
...
<script type="text/javascript">
    function btnsubmit() {
        var form = document.getElementById("updateCompetitionForm");
        if (form.cname.value.length < 1 || form.ctype.value.length < 1 ||
            form.cname.value == null || form.ctype.value == null) {
    ...
    $("#returnbtn").on('click', function () {
        window.location.href = "/competition/findAll";
    })
