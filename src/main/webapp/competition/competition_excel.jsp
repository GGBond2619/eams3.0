            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    ...
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 比赛信息管理 - 比赛列表 </span>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-toolbar clearfix">
                                <div class="toolbar-btn-action">
                                    <form class="form-horizontal" id="findForm"
                                          action="/competition/findCompetitionByEle" method="get"
                                          onsubmit="return false;">
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">比赛名称</label>
                                            <div class="col-md-7">
                                                <input class="form-control" type="text" placeholder="比赛名称..."
                                                       name="cname">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">比赛类型</label>
                                            <div class="col-md-7">
                                                <input class="form-control" type="text" placeholder="比赛类型..."
                                                       name="ctype">
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-9 col-md-offset-3">
                                            <button class="btn btn-w-md btn-round btn-primary"
                                                    id="example-success-notify" href="findCompetitionByEle"
                                            ...
                                            <a class="btn btn-w-md btn-round btn-cyan" data-placement="top"
                                               href="/competition/competition_add.jsp">
                                                添加比赛信息
                                            </a>
                                        </div>
                            ...
                            <form action="/competition/export" id="exportForm">
                                            ...
                                            <div class="card-body">
                                                <div class="example-box">
                                                    <div class="form-group row m-b-10">
                                                        <div class="col-xs-6"> 比赛名称</div>
                                                        <div class="col-xs-6">
                                                            <label class="lyear-switch switch-solid switch-primary">
                                                                <input type="checkbox" checked="checked" value="cname"
                                                                       name="checkColumn">
                                                                <span></span>
                                                            </label>
                                                        </div>
                                                    ...
                                                    <div class="form-group row m-b-10">
                                                        <div class="col-xs-6"> 比赛类型</div>
                                                        <div class="col-xs-6">
                                                            <label class="lyear-switch switch-solid switch-primary">
                                                                <input type="checkbox" checked="checked" value="ctype"
                                                                       name="checkColumn">
                                                                <span></span>
                                                            </label>
                                                        </div>
                                                    ...
                                                    <div class="form-group row m-b-10">
                                                        <div class="col-xs-6"> 比赛地点</div>
                                                        <div class="col-xs-6">
                                                            <label class="lyear-switch switch-solid switch-primary">
                                                                <input type="checkbox" checked="checked" value="cplace"
                                                                       name="checkColumn">
                                                                <span></span>
                                                            </label>
                                                        </div>
                            ...
                            <ul class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <c:forEach items="${competitionlist}" var="competition" varStatus="xh">
                                            <tr>
                                                <td>${xh.count}</td>
                                                <td>${competition.cname}</td>
                                                <td>${competition.ctype}</td>
                                                <td>${competition.cplace}</td>
                                                <td>${competition.cbegintime}</td>
                                                <td>
                                                    <div class="btn-group">
                                                        <a class="btn btn-xs btn-default"
                                                           href="${pageContext.request.contextPath}/competition/updateCompetition_page?cid=${competition.cid}"
                                                           title="编辑"
                                                           data-toggle="tooltip"><i class="mdi mdi-pencil"></i></a>
                                                        <a class="btn btn-xs btn-default"
                                                           onclick="ifdel(${competition.cid})" title="删除"
                                                           data-toggle="tooltip"><i
                                                                class="mdi mdi-window-close"></i></a>
                                                        <a class="btn btn-xs btn-default"
                                                           href="${pageContext.request.contextPath}/enjoyCompetition/findByCid?cid=${competition.cid}"
                                                           title="参赛学生列表"
                                                           data-toggle="tooltip"><i class="mdi mdi-account-location"></i></a>
                                                        <a class="btn btn-xs btn-default"
                                                           href="${pageContext.request.contextPath}/enjoyCompetition/addStudent_page?cid=${competition.cid}"
                                                           title="新增参赛学生"
                                                           data-toggle="tooltip"><i class="mdi mdi-account-multiple-plus"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        </c:forEach>
        ...
        $.confirm({
            ...
            buttons: {
                tryAgain: {
                    ...
                    btnClass: 'btn-orange',
                    action: function () {
                        location = "/competition/deleteByCid_excel?cid=" + cid;
                    }
                },
                close: {
                    text: '取消'
