            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    ...
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 比赛信息管理 - 添加比赛 </span>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form id="addCompetitionForm" action="/competition/addCompetition" data-parsley-validate
                                      class="form-horizontal form-label-left" onsubmit="return false;">
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                               for="addCompetitionForm">比赛名称
                                            <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="last-name" name="cname" required="required"
                                                   class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="addCompetitionForm"
                                               class="control-label col-md-3 col-sm-3 col-xs-12">比赛类型
                                            <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="ctype" class="form-control col-md-7 col-xs-12" type="text"
                                                   required="required" name="ctype">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                               for="addCompetitionForm">开始时间</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                               for="addCompetitionForm">比赛地点</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-sm-6 col-xs-18 col-md-offset-4">
                                            <a class="btn btn-primary" type="button" href="/competition/findAll">取消
                                            </a>
...
<script type="text/javascript">
    function btnsubmit() {
        var form = document.getElementById("addCompetitionForm");
        if (form.cname.value.length < 1 || form.cname.value == null) {
            alert("请检查比赛名称输入项！")
        } else if (form.ctype.value.length < 1 || form.ctype.value == null) {
            alert("请检查比赛类型输入项！")
        } else {
            form.submit();
        }
