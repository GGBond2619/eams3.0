            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    ...
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 元器件管理 - 元器件操作 - 日志查看 </span>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-toolbar clearfix">
                                <div class="toolbar-btn-action">
                                    <form class="form-horizontal" id="findForm" action="/devicelog/findDeviceLogByEle" method="get"
                                          onsubmit="return false;">
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">元器件名称</label>
                                            <div class="col-md-7">
                                                <input class="form-control" type="text" placeholder="元器件名称..."
                                                       name="dname">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="example-box" required="required">
                                                        <label class="lyear-radio radio-inline radio-primary">
                                                            <input type="radio" name="dltype" value="0" checked><span>无</span>
                                                        </label>
                                                        <label class="lyear-radio radio-inline radio-primary">
                                                            <input type="radio" name="dltype" value="1"><span>增加</span>
                                                        </label>
                                                        <label class="lyear-radio radio-inline radio-primary">
                                                            <input type="radio" name="dltype" value="-1"><span>减少</span>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-daterange input-group">
                                                    <input class="form-control js-datepicker" data-date-format="yyyy-mm-dd" type="text" id="date1" name="date1" placeholder="从">
                                                    <span class="input-group-addon"><i class="mdi mdi-chevron-right"></i></span>
                                                    <input class="form-control js-datepicker" data-date-format="yyyy-mm-dd" type="text" id="date2" name="date2" placeholder="至">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-9 col-md-offset-3">
                                            <button class="btn btn-w-md btn-round btn-primary"
                                                    id="example-success-notify" href="/devicelog/findDeviceLogByEle"
                                                    data-placement="top" title="模糊查询 部分项没有可不填">筛选
                                            </button>
                            ...
                            <form action="/devicelog/export" id="exportForm">
                                            ...
                                            <div class="card-body">
                                                <div class="example-box">
                                                    ...
                                                    <div class="form-group row m-b-10">
                                                        <div class="col-xs-6"> 元器件名称</div>
                                                        <div class="col-xs-6">
                                                            <label class="lyear-switch switch-solid switch-primary">
                                                                <input type="checkbox" checked="checked" value="dname"
                                                                       name="checkColumn">
                                                                <span></span>
                                                            </label>
                                                        </div>
                                                    ...
                                                    <div class="form-group row m-b-10">
                                                        <div class="col-xs-6"> 修改类型</div>
                                                        <div class="col-xs-6">
                                                            <label class="lyear-switch switch-solid switch-primary">
                                                                <input type="checkbox" checked="checked" value="dltype"
                                                                       name="checkColumn">
                                                                <span></span>
                                                            </label>
                                                        </div>
                                                    ...
                                                    <div class="form-group row m-b-10">
                                                        <div class="col-xs-6"> 修改数量</div>
                                                        <div class="col-xs-6">
                                                            <label class="lyear-switch switch-solid switch-primary">
                                                                <input type="checkbox" checked="checked" value="dlcount"
                                                                       name="checkColumn">
                                                                <span></span>
                                                            </label>
                                                        </div>
                                                    ...
                                                    <div class="form-group row m-b-10">
                                                        <div class="col-xs-6"> 修改时间</div>
                                                        <div class="col-xs-6">
                                                            <label class="lyear-switch switch-solid switch-primary">
                                                                <input type="checkbox" checked="checked" value="dltime"
                                                                       name="checkColumn">
                                                                <span></span>
                                                            </label>
                                                        </div>
                                                    ...
                                                    <div class="form-group row m-b-10">
                                                        <div class="col-xs-6"> 备注信息</div>
                                                        <div class="col-xs-6">
                                                            <label class="lyear-switch switch-solid switch-primary">
                                                                <input type="checkbox" checked="checked" value="dlog"
                                                                       name="checkColumn">
                                                                <span></span>
                                                            </label>
                                                        </div>
                            ...
                            <ul class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <c:forEach items="${deviceloglist}" var="devicelog" varStatus="xh">
                                            <tr>
                                                <td>${xh.count}</td>
                                                <td>${devicelog.dname}</td>
                                                <td>${devicelog.dltype==1?"增加":"减少"}</td>
                                                <td>${devicelog.dlcount}</td>
                                                <td>${devicelog.dltime}</td>
                                                <td>${devicelog.dlog}</td>
                                                <td>
                                                    <div class="btn-group">
                                                        <a class="btn btn-xs btn-default"
                                                           onclick="ifdel(${devicelog.dlno})" title="删除"
        ...
        $.confirm({
            ...
            buttons: {
                tryAgain: {
                    ...
                    btnClass: 'btn-orange',
                    action: function () {
                        location = "/devicelog/deleteByDlno?dlno=" + dlno;
                    }
                },
                close: {
                    text: '取消'
