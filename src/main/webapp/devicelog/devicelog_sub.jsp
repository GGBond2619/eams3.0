            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    ...
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 元器件信息管理 - 元器件操作 - 元器件使用/分发 </span>
                    </div>
                        ...
                        <div class="card">
                            <div class="tab-content">
                                <div class="tab-pane active">
                                    <form id="subdeviceForm" action="/devicelog/adddevicelog_sub" name="edit-form"
                                          class="edit-form">
                                        ...
                                        <div class="form-group">
                                            <label for="dlcount">使用数量</label>
                                            <input class="form-control" type="text" id="dlcount" name="dlcount"
                                                   placeholder="请输入使用数量">
                                        </div>
                                        <div class="form-group">
                                            <label for="dlog">备注信息</label>
                                            <textarea class="form-control" id="dlog" rows="5" name="dlog"
                                                      placeholder="请输入备注信息"></textarea>
                                        </div>

                                        <div class="form-group">
                                            <a onclick="btnsubmit()" class="btn btn-primary m-r-5">确 定</a>
...
<script type="text/javascript">
    function btnsubmit() {
        var retNum = /^\d*$/;
        var form = document.getElementById("subdeviceForm");
        var select=document.getElementById('status').value;
        if(select == 0){
            alert("请检查元器件选择项！")
        }else if(!retNum.test(form.dlcount.value)){
            alert("请检查数量输入项！")
        }else if (Number(form.dlcount.value) > Number(count)) {
            alert("库存不足！ 所选元器件仅剩" + count + "件");
        } else {
            form.submit();
        }
    }
