            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    ...
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 元器件信息管理 - 添加元器件类型 </span>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form id="addDeviceForm" action="/device/addDevice" data-parsley-validate
                                      class="form-horizontal form-label-left" onsubmit="return false;">
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="addDeviceForm">元器件编号
                                            <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="first-name" required="required"
                                                   class="form-control col-md-7 col-xs-12" name="dno">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="addDeviceForm">元器件名称
                                            <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="last-name" name="dname" required="required"
                                                   class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="addDeviceForm" class="control-label col-md-3 col-sm-3 col-xs-12">元器件类型
                                            <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="dtype" class="form-control col-md-7 col-xs-12" type="text"
                                                   required="required" name="dtype">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="addDeviceForm">元器件数量
                                            <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="dcount" name="dcount" required="required"
                                                   class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-sm-6 col-xs-18 col-md-offset-4">
                                            <a class="btn btn-primary" type="button" href="/device/findAll">取消
                                            </a>
...
<script type="text/javascript">
    function btnsubmit() {
        ...
        if (form.dno.value.length < 1 || form.dno.value == null   ) {
            alert("请检查编号号输入项！")
        }else if(form.dname.value.length < 1 || form.dname.value == null){
            alert("请检查名称输入项！")
        }else if(form.dtype.value.length < 1 || form.dtype.value == null){
            alert("请检查类型输入项！")
        }
        else{
            form.submit();
