            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    ...
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 元器件信息管理 - 元器件列表 </span>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-toolbar clearfix">
                                <div class="toolbar-btn-action">
                                    <form class="form-horizontal" id="findForm" action="/device/findDeviceByEle" method="get"
                                          onsubmit="return false;">
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">元器件编号</label>
                                            <div class="col-md-7">
                                                <input class="form-control" type="text" placeholder="元器件编号..."
                                                       name="dno">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">元器件类型</label>
                                            <div class="col-md-7">
                                                <input class="form-control" type="text" placeholder="元器件类型..."
                                                       name="dtype">
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-9 col-md-offset-3">
                                            <button class="btn btn-w-md btn-round btn-primary"
                                                    id="example-success-notify" href="findDeviceByEle"
                                            ...
                                            <a class="btn btn-w-md btn-round btn-danger" data-placement="top" href="${pageContext.request.contextPath}/down/download.do?fileName=device">
                                                下载导入模板
                                            </a>
                                        </div>
                            ...
                            <form action="/device/export" id="exportForm">
                                            ...
                                            <div class="card-body">
                                                <div class="example-box">
                                                    ...
                                                    <div class="form-group row m-b-10">
                                                        <div class="col-xs-6"> 元器件编号</div>
                                                        <div class="col-xs-6">
                                                            <label class="lyear-switch switch-solid switch-primary">
                                                                <input type="checkbox" checked="checked" value="dno"
                                                                       name="checkColumn">
                                                                <span></span>
                                                            </label>
                                                        </div>
                                                    ...
                                                    <div class="form-group row m-b-10">
                                                        <div class="col-xs-6"> 元器件类型</div>
                                                        <div class="col-xs-6">
                                                            <label class="lyear-switch switch-solid switch-primary">
                                                                <input type="checkbox" checked="checked" value="dtype"
                                                                       name="checkColumn">
                                                                <span></span>
                                                            </label>
                                                        </div>
                                                    ...
                                                    <div class="form-group row m-b-10">
                                                        <div class="col-xs-6"> 剩余数量</div>
                                                        <div class="col-xs-6">
                                                            <label class="lyear-switch switch-solid switch-primary">
                                                                <input type="checkbox" checked="checked" value="dcount"
                                                                       name="checkColumn">
                                                                <span></span>
                                                            </label>
                                                        </div>
                            ...
                            <ul class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <c:forEach items="${devicelist}" var="device" varStatus="xh">
                                            <tr>
                                                <td>${xh.count}</td>
                                                <td>${device.dno}</td>
                                                <td>${device.dname}</td>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a class="btn btn-xs btn-default"
                                                           href="/device/updateDevice_page?dno=${device.dno}"
                                                           title="编辑"
                                                           data-toggle="tooltip"><i class="mdi mdi-pencil"></i></a>
                                                        <a class="btn btn-xs btn-default"
                                                           onclick="ifdel(${device.dno})" title="删除"
        ...
        $.confirm({
            ...
            buttons: {
                tryAgain: {
                    ...
                    btnClass: 'btn-orange',
                    action: function () {
                        location = "/device/deleteByDno_excel?dno=" + dno;
                    }
                },
                close: {
                    text: '取消'
