            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    ...
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 元器件信息管理 - 修改元器件 </span>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form id="updateDeviceForm" action="${pageContext.request.contextPath}/device/updateDevice" data-parsley-validate
                                      class="form-horizontal form-label-left" onsubmit="return false;">
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                               for="updateDeviceForm">元器件编号
                                            <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="dno" required="required"
                                                   class="form-control col-md-7 col-xs-12" name="dno"
                                                   value="${device.dno}" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                               for="updateDeviceForm">元器件名称
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="dname" name="dname" value="${device.dname}"
                                                   class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                               for="updateDeviceForm">类型
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="dtype" name="dtype" value="${device.dtype}"
                                                   class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="updateDeviceForm"
                                               class="control-label col-md-3 col-sm-3 col-xs-12">数量</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="sclass" class="form-control col-md-7 col-xs-12" type="text"
                                                   value="${device.dcount}" name="dcount">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-sm-6 col-xs-18 col-md-offset-4">
                                            <button id="returnbtn" class="btn btn-primary"
                                                    onclick="history.back(-1);return false;" type="button">取消
                                            </button>
...
<script type="text/javascript">
    function btnsubmit() {
        var form = document.getElementById("updateDeviceForm");
        if (form.dname.value.length < 1) {
            ...
            setTimeout(function () {
                ...
                setTimeout(function () {
                    var form = document.getElementById('updateDevice');
                    //可在此修改input
                    setTimeout(function () {
                        //可在此修改input
                        form.submit();
    ...
    $("#returnbtn").on('click', function () {
        window.location.href = "updateDevice";
    })
