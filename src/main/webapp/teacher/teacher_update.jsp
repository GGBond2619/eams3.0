            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    ...
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 指导教师信息管理 - 修改教师信息 </span>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form id="updateTeacherForm" action="/teacher/updateTeacher" data-parsley-validate
                                      class="form-horizontal form-label-left" onsubmit="return false;">
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                               for="updateTeacherForm">教师号
                                            <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="first-name" required="required"
                                                   class="form-control col-md-7 col-xs-12" name="tno"
                                                   value="${teacher.tno}" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                               for="updateTeacherForm">姓名
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="last-name" name="tname" value="${teacher.tname}"
                                                   class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="updateTeacherForm"
                                               class="control-label col-md-3 col-sm-3 col-xs-12">职位</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="tpos" class="form-control col-md-7 col-xs-12" type="text"
                                                   value="${teacher.tpos}" name="tpos">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                               for="updateTeacherForm">qq账号</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                               for="updateTeacherForm">手机号</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-sm-6 col-xs-18 col-md-offset-4">
                                            <button id="returnbtn" class="btn btn-primary" href="/teacher/updateTeacher" type="button">取消
                                            </button>
...
<script type="text/javascript">
    function btnsubmit() {
        ...
        if (form.tname.value.length < 2 || form.tname.value == null || form.tpos.value == null || form.tpos.value == null) {
    ...
    $("#returnbtn").on('click',function () {
        window.location.href="/teacher/updateTeacher";
    })
