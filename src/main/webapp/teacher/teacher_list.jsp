            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    ...
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 指导教师信息管理 - 指导教师列表 </span>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-toolbar clearfix">
                                <div class="toolbar-btn-action">
                                    <a class="btn btn-primary m-r-5" href="teacher_add.jsp"><i class="mdi mdi-plus"></i>
                                        添加</a>
                                    <a class="btn btn-danger" onclick="batchDeletes()"><i
                            ...
                            <ul class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <c:forEach items="${list}" var="teacher" varStatus="xh">
                                            <tr>
                                                <td>
                                                    <label class="lyear-checkbox checkbox-primary">
                                                        <input type="checkbox" id="subcheck" name="subcheck"
                                                               value="${teacher.tno}"><span></span>
                                                    </label>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a class="btn btn-xs btn-default"
                                                           href="updateTeacher_page?tno=${teacher.tno}&inUpdatePage=list"
                                                        title="编辑"
                                ...
                                <ul class="pager">
                                    ...
                                    <ul class="pagination">
                                        <li><a id="begin" href="/teacher/findByPage?page=${1}"><span>«</span></a></li>
                                        <li><a href="/teacher/findByPage?page=${page.prefPage}" class="pager">上一页</a></li>
                                        <c:if test="${page.totalPages > 4}">
                                            <c:if test="${page.currentPage == page.totalPages - 1}">
                                                <li>
                                                    <a href="/teacher/findByPage?page=${page.currentPage-3}"><span>${page.currentPage-3}</span></a>
                                                </li>
                                            </c:if></c:if>
                                        <c:if test="${page.currentPage == page.totalPages}"><c:if
                                                test="${page.totalPages>=5}">
                                            <li>
                                                <a href="/teacher/findByPage?page=${page.currentPage-4}"><span>${page.currentPage-4}</span></a>
                                            </li>
                                        ...
                                        <c:if test="${page.currentPage > 2}">
                                            <li>
                                                <a href="/teacher/findByPage?page=${page.currentPage-2}"><span>${page.currentPage-2}</span></a>
                                            </li>
                                        </c:if><c:if test="${page.currentPage > 1}">
                                        <li>
                                            <a href="/teacher/findByPage?page=${page.currentPage-1}"><span>${page.currentPage-1}</span></a>
                                        </li>
                                    </c:if>
                                        ...
                                        <li><a href="/teacher/findByPage?page=${page.nextPage}" class="pager">下一页</a></li>
                                        <li><a href="/teacher/findByPage?page=${page.totalPages}">»</a></li>
                                    </ul>
                                </ul>
                            </ul>
                        </div>
        ...
        $.confirm({
            ...
            buttons: {
                tryAgain: {
                    ...
                    btnClass: 'btn-orange',
                    action: function () {
                        location = "/teacher/deleteByTno_page?tno=" + tno;
                    }
                },
                close: {
                    text: '取消'
