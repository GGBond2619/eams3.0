            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    ...
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 活动信息管理 - 修改活动信息 </span>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form id="updateActivityForm" action="/activity/updateActivity" data-parsley-validate
                                      class="form-horizontal form-label-left" onsubmit="return false;">
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                               for="updateActivityForm">活动编号
                                            <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="first-name" required="required"
                                                   class="form-control col-md-7 col-xs-12" name="ano"
                                                   value="${activity.ano}" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                               for="updateActivityForm">活动名称
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="last-name" name="aname" value="${activity.aname}"
                                                   class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                               for="updateActivityForm">开始时间
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class="form-control js-datetimepicker" type="text" id="begintime"
                                                   name="begintime" placeholder="请选择具体时间" value="${activity.begintime}"
                                                   data-side-by-side="true" data-locale="zh-cn"
                                                   data-format="YYYY-MM-DD HH:mm"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="updateActivityForm"
                                               class="control-label col-md-3 col-sm-3 col-xs-12">结束时间</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class="form-control js-datetimepicker" type="text" id="endtime"
                                                   name="endtime" placeholder="请选择具体时间" value="${activity.endtime}"
                                                   data-side-by-side="true" data-locale="zh-cn"
                                                   data-format="YYYY-MM-DD HH:mm"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="updateActivityForm">活动目的</label>
                                        <textarea class="form-control" id="aim" rows="5" name="aim" value="${activity.aim}
                                                  placeholder="请输入活动目的"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="updateActivityForm">活动要求</label>
                                        <textarea class="form-control" id="ask" rows="5" name="ask" value="${activity.ask}"
                                                  placeholder="请输入活动要求"></textarea>
                                    </div>
                                    <div class="ln_solid"></div>
                                    <div class="form-group">
                                        <div class="col-md-6 col-sm-6 col-xs-18 col-md-offset-4">
                                            <button id="returnbtn" class="btn btn-primary"
                                                    onclick="javascript:history.back(-1);return false;" type="button">取消
                                            </button>
...
<script type="text/javascript">
    function btnsubmit() {
        ...
        if (form.aname.value.length < 1) {
            lightyear.loading('show');
            setTimeout(function () {
                lightyear.loading('hide');
                lightyear.notify('请检查输入项！', 'danger', 100);
            }, 1e3)
        }else if(form.begintime.value > form.endtime.value){
            lightyear.loading('show');
            setTimeout(function () {
                lightyear.loading('hide');
                lightyear.notify('开始时间必须小于结束时间！', 'danger', 100);
            }, 1e3)
        } else {
            lightyear.loading('show');
            // 假设ajax提交操作
            setTimeout(function () {
                ...
                setTimeout(function () {
                    var form = document.getElementById('updateActivity');
                    //可在此修改input
                    setTimeout(function () {
                        //可在此修改input
                        form.submit();
    ...
    $("#returnbtn").on('click', function () {
        window.location.href = "updateActivity";
    })
