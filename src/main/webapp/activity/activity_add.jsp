            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form id="addActivityForm" action="${pageContext.request.contextPath}/activity/addActivity" data-parsley-validate
                                      class="form-horizontal form-label-left" onsubmit="return false;">
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                               for="addActivityForm">活动名称
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="last-name" name="aname"
                                                   class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                               for="addActivityForm">开始时间
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class="form-control js-datetimepicker" type="text" id="begintime"
                                                   name="begintime" placeholder="请选择具体时间" value=""
                                                   data-side-by-side="true" data-locale="zh-cn"
                                                   data-format="YYYY-MM-DD HH:mm"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="addActivityForm"
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class="form-control js-datetimepicker" type="text" id="endtime"
                                                   name="endtime" placeholder="请选择具体时间" value=""
                                                   data-side-by-side="true" data-locale="zh-cn"
                                                   data-format="YYYY-MM-DD HH:mm"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="addActivityForm">活动目的</label>
                                        <textarea class="form-control" id="aim" rows="5" name="aim"
                                                  placeholder="请输入活动目的"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="addActivityForm">活动要求</label>
                                        <textarea class="form-control" id="ask" rows="5" name="ask"
                                                  placeholder="请输入活动要求"></textarea>
                                    </div>
                                    <div class="ln_solid"></div>
                                    <div class="form-group">
                                        <div class="col-md-6 col-sm-6 col-xs-18 col-md-offset-4">
                                            <a class="btn btn-primary" type="button" onclick="javascript:history.back(-1);return false;" href="/activity/findAll">取消
                                            </a>
