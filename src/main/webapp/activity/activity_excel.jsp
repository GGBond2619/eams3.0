            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    ...
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 活动信息管理 - 活动列表 </span>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-toolbar clearfix">
                                ...
                                <%--                                            </button>--%>
                                <%--                                            <a class="btn btn-w-md btn-round btn-danger" data-placement="top" href="${pageContext.request.contextPath}/down/download.do?fileName=activity">--%>
                                <%--                                                下载导入模板--%>
                                <%--                                            </a>--%>
                                <%--                                        </div>--%>
                                <div class="card-toolbar clearfix">
                                    <div class="toolbar-btn-action">
                                        <a class="btn btn-primary m-r-5 mdi mdi-whatsapp"
                                           href="${pageContext.request.contextPath}/activity/activity_add.jsp"><i
                                                ></i>
                                            新增活动</a>

                                        <button class="btn btn btn-info mdi mdi-content-duplicate" data-placement="top"
                                                data-toggle="modal" data-target=".bs-example-modal-sm">导出Excel
                                        </button>
                                    </div>
                                </div>
                                <%--                                    </div>--%>
                            ...
                            <form action="/activity/export" id="exportForm">
                                            ...
                                            <div class="card-body">
                                                <div class="example-box">
                                                    ...
                                                    <div class="form-group row m-b-10">
                                                        ...
                                                        <div class="col-xs-6">
                                                            <label class="lyear-switch switch-solid switch-primary">
                                                                <input type="checkbox" checked="checked" value="begintime"
                                                                       name="checkColumn">
                                                                <span></span>
                                                            </label>
                                                        </div>
                                                    ...
                                                    <div class="form-group row m-b-10">
                                                        <div class="col-xs-6"> 结束时间</div>
                                                        <div class="col-xs-6">
                                                            <label class="lyear-switch switch-solid switch-primary">
                                                                <input type="checkbox" checked="checked" value="endtime"
                                                                       name="checkColumn">
                                                                <span></span>
                                                            </label>
                                                        </div>
                                                    ...
                                                    <div class="form-group row m-b-10">
                                                        <div class="col-xs-6"> 活动地点</div>
                                                        <div class="col-xs-6">
                                                            <label class="lyear-switch switch-solid switch-primary">
                                                                <input type="checkbox" checked="checked" value="site"
                                                                       name="checkColumn">
                                                                <span></span>
                                                            </label>
                                                        </div>
                            ...
                            <ul class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <c:forEach items="${activitylist}" var="activity" varStatus="xh">
                                            <tr>
                                                <td>${xh.count}</td>
                                                ...
                                                <td>${activity.site}</td>
                                                <td>${activity.master}</td>
                                                <td>${activity.aim}</td>
                                                <td>${activity.ask}</td>
                                                <td>
                                                    <div class="btn-group">
                                                        <a class="btn btn-xs btn-default"
                                                           href="${pageContext.request.contextPath}/activity/updateActivity_page?ano=${activity.ano}"
                                                           title="编辑"
                                                           data-toggle="tooltip"><i class="mdi mdi-pencil"></i></a>
                                                        <a class="btn btn-xs btn-default"
                                                           onclick="ifdel(${activity.ano})" title="删除"
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a class="btn btn-xs btn-default"
                                                           href="${pageContext.request.contextPath}/activity/findStudents?ano=${activity.ano}"
                                                           title="已签到学生列表"
                                                           data-toggle="tooltip"><i class="mdi mdi-account-location"></i></a>
                                                        <a class="btn btn-xs btn-default"
                                                           href="${pageContext.request.contextPath}/sign/addStudent_page?ano=${activity.ano}"
                                                           title="学生签到"
        ...
        $.confirm({
            ...
            buttons: {
                tryAgain: {
                    ...
                    btnClass: 'btn-orange',
                    action: function () {
                        location = "/activity/deleteByAno_excel?ano=" + ano;
                    }
                },
                close: {
                    text: '取消'
