            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    ...
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 比赛信息管理 - 参赛信息 - 添加参赛学生</span>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form id="addStudentForm"
                                      action="${pageContext.request.contextPath}/enjoyCompetition/addStudent"
                                      data-parsley-validate
                                      class="form-horizontal form-label-left" onsubmit="return false;">
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="addStudentForm">竞赛编号
                                            <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="first-name" required="required"
                                                   class="form-control col-md-7 col-xs-12" name="cid"
                                                   value="${competition.cid}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="addStudentForm">竞赛名称
                                            <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="last-name" name="cname" required="required"
                                                   class="form-control col-md-7 col-xs-12" value="${competition.cname}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="addStudentForm">学生学号
                                            <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="sno" name="sno" required="required"
