            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    ...
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 比赛信息管理 - 参赛信息 - 参赛列表 </span>
                    </div>
                            ...
                            <div class="card-toolbar clearfix">
                                <div class="toolbar-btn-action">
                                    <form class="form-horizontal" id="findForm" action="/enjoyCompetition/findByEle"
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">竞赛名称</label>
                                            <div class="col-md-7">
                                                <input class="form-control" type="text" placeholder="竞赛名称..."
                                                       name="cname">
                                            </div>
                                        </div>
                                    </form>
                                    <div class="form-group">
                                        <div class="col-md-9 col-md-offset-3">
                                            <button class="btn btn-w-md btn-round btn-primary"
                                                    id="example-success-notify" href="/enjoyCompetition/findByEle"
...
<%--                                            </button>--%>
<%--                                            <a class="btn btn-w-md btn-round btn-danger" data-placement="top"--%>
<%--                                               href="${pageContext.request.contextPath}/down/download.do?fileName=enjoycompetition">--%>
<%--                                                下载导入模板--%>
<%--                                            </a>--%>
                                        </div>
                            ...
                            <ul class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <c:forEach items="${enjoycompetitionlist}" var="enjoycompetition">
                                            <tr>
                                                <d:forEach items="${enjoycompetition.students}" var="student">
                                                <td>${enjoycompetition.cid}</td>
                                                <td>${enjoycompetition.cname}</td>
                                                <td>${student.sno}</td>
                                                <td>${student.sname}</td>
                                                <td>${student.ssex}</td>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a class="btn btn-xs btn-default"
                                                           onclick="ifdel(${student.sno},${enjoycompetition.cid})" title="删除"
        ...
        $.confirm({
            ...
            buttons: {
                tryAgain: {
                    ...
                    btnClass: 'btn-orange',
                    action: function () {
                        location = "/enjoyCompetition/deleteByCidSno?page=enjoycompetition&sno=" + sno+"&cid="+cid;
                    }
                },
                close: {
                    text: '取消'
