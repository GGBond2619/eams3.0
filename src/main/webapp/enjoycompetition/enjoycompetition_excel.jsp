            ...
            <div class="lyear-layout-sidebar-scroll">
                ...
                <nav class="sidebar-main">
                    <ul class="nav nav-drawer">
                        ...
                        <li class="nav-item">
                            <a href="${pageContext.request.contextPath}/errorInfo.jsp"><i
                                    class="mdi mdi-comment-remove-outline"></i> 错误信息反馈</a>
                        </li>
                    </ul>
                </nav>
            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    ...
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 比赛信息管理 - 参赛信息 - 查看参赛学生 </span>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <form action="${pageContext.request.contextPath}/enjoyCompetition/export" id="exportForm">
                                            ...
                                            <div class="card-body">
                                                <div class="example-box">
                                                    <div class="form-group row m-b-10">
                                                        <div class="col-xs-6"> 竞赛编号</div>
                                                        <div class="col-xs-6">
                                                            <label class="lyear-switch switch-solid switch-primary">
                                                                <input type="checkbox" checked="checked" value="cid"
                                                                       name="checkColumn">
                                                                <span></span>
                                                            </label>
                                                        </div>
                            ...
                            <ul class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <c:forEach items="${studentlist}" var="student" varStatus="xh">
                                            <tr>
                                                <td>${xh.count}</td>
                                                <td>${cid}</td>
                                                <td>${cname}</td>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a class="btn btn-xs btn-default"
                                                           onclick="ifdel(${cid},${student.sno})" title="删除"
        ...
        $.confirm({
            ...
            buttons: {
                tryAgain: {
                    ...
                    btnClass: 'btn-orange',
                    action: function () {
                        location = "/enjoyCompetition/deleteByCidSno?page=competition&cid=" + cid + "&sno=" + sno;
                    }
                },
                close: {
                    text: '取消'
