            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    ...
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 活动信息管理 - 活动签到 </span>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form id="addStudentForm"
                                      action="${pageContext.request.contextPath}/sign/addStudent"
                                      data-parsley-validate
                                      class="form-horizontal form-label-left" onsubmit="return false;">
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="addStudentForm">活动编号
                                            <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="first-name" required="required"
                                                   class="form-control col-md-7 col-xs-12" name="ano"
                                                   value="${activity.ano}" readonly="readonly">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="addStudentForm">活动名称
                                            <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="last-name" name="cname" required="required"
                                                   class="form-control col-md-7 col-xs-12" value="${activity.aname}">
                                        </div>
                                    </div>
                                    <div class="form-group">
