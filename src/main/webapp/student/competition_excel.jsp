            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    ...
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 学生信息管理 - 查看比赛信息 </span>
                    </div>
        ...
        <main class="lyear-layout-content">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <a class="btn btn-secondary" data-placement="top"
                                    data-toggle="modal" href="${pageContext.request.contextPath}/student/btnreturn?page=${cspage}"
                                    title="返回竞赛信息页面">返回
                            </a>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a class="btn btn-xs btn-default"
                                                           onclick="ifdel(${competition.cid},${sno})" title="删除"
        ...
        $.confirm({
            ...
            buttons: {
                tryAgain: {
                    ...
                    btnClass: 'btn-orange',
                    action: function () {
                        location = "/enjoyCompetition/deleteByCidSno?page=student&studentpage=${cspage}&cid=" + cid + "&sno=" + sno;
                    }
                },
                close: {
                    text: '取消'
