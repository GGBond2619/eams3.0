            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    ...
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 学生信息管理 - 查看活动信息</span>
                    </div>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a class="btn btn-xs btn-default"
                                                           onclick="ifdel(${activity.ano},${sno})" title="删除"
        ...
        $.confirm({
            ...
            buttons: {
                tryAgain: {
                    ...
                    btnClass: 'btn-orange',
                    action: function () {
                        location = "/sign/deleteByAnoSno?page=student$studentpage=${page}&ano=" + ano + "&sno=" + sno;
                    }
                },
                close: {
                    text: '取消'
