            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    ...
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 学生信息管理 - 条件筛选 导入到出Excel </span>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-toolbar clearfix">
                                <div class="toolbar-btn-action">
                                    <form class="form-horizontal" id="findForm" action="/student/findStudentByEle" method="get"
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-9 col-md-offset-3">
                                            <button class="btn btn-w-md btn-round btn-primary"
                                                    id="example-success-notify" href="findStudentByEle"
                                            ...
                                            <a class="btn btn-w-md btn-round btn-danger" data-placement="top" href="${pageContext.request.contextPath}/down/download.do?fileName=student">
                                                下载导入模板
                                            </a>
                                        </div>
                            ...
                            <form action="/student/export" id="exportForm">
                                            ...
                                            <div class="card-body">
                                                <div class="example-box">
                                                    ...
                                                    <div class="form-group row m-b-10">
                                                        ...
                                                        <div class="col-xs-6">
                                                            <label class="lyear-switch switch-solid switch-primary">
                                                                <input type="checkbox" checked="checked" value="ssex"
                                                                       name="checkColumn">
                                                                <span></span>
                                                            </label>
                                                        </div>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a class="btn btn-xs btn-default"
                                                           href="${pageContext.request.contextPath}/student/updateStudent_page?sno=${student.sno}&inUpdatePage=excel"
                                                           title="编辑"
                                                        ...
                                                        <a class="btn btn-xs btn-default"
                                                           href="${pageContext.request.contextPath}/student/findCompetitions_page?sno=${student.sno}&page=excel" title="查看参赛信息"
                                                           data-toggle="tooltip"><i
                                                                class="mdi mdi-flag-checkered"></i></a>
                                                        <a class="btn btn-xs btn-default"
                                                           href="${pageContext.request.contextPath}/student/findActivitys_page?sno=${student.sno}&page=excel" title="查看活动信息"
                                                           data-toggle="tooltip"><i
        ...
        $.confirm({
            ...
            buttons: {
                tryAgain: {
                    ...
                    btnClass: 'btn-orange',
                    action: function () {
                        location = "/student/deleteBySno_excel?sno=" + sno;
                    }
                },
                close: {
                    text: '取消'
