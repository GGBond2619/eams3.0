            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    ...
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 协会成员信息管理 - 添加成员 </span>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form id="addStudentForm" action="/student/addStudent" data-parsley-validate
                                      class="form-horizontal form-label-left" onsubmit="return false;">
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="addStudentForm">学号
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="addStudentForm">姓名
                                            <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="last-name" name="sname" required="required"
                                                   class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="addStudentForm">年级
                                            <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="syear" name="syear" required="required"
                                                   class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="addStudentForm" class="control-label col-md-3 col-sm-3 col-xs-12">班级
                                            <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="sclass" class="form-control col-md-7 col-xs-12" type="text"
                                                   required="required" name="sclass">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="addStudentForm" class="control-label col-md-3 col-sm-3 col-xs-12">性别
                                            <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="example-box" required="required">
                                                <label class="lyear-radio radio-inline radio-primary">
                                                    <input type="radio" name="ssex" value="男" checked><span>男</span>
                                                </label>
                                                <label class="lyear-radio radio-inline radio-primary">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="addStudentForm">qq账号</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="addStudentForm">手机号</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
...
<script type="text/javascript">
    function btnsubmit() {
        ...
        if (form.sno.value.length < 11 || form.sno.value == null) {
            alert("请检查学号输入项！")
        } else if (form.sname.value.length < 2 || form.sname.value == null) {
            alert("请检查姓名输入项！")
        } else if (form.syear.value.length < 4 || form.syear.value == null) {
            alert("请检查年级输入项！")
        } else if (form.sclass.value.length < 1 || form.sclass.value == null) {
            alert("请检查班级输入项！")
        } else {
            form.submit();
        }
